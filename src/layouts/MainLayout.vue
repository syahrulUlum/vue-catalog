<template>
  <v-navigation-drawer v-model="drawer" class="bg-indigo" theme="dark" permanent>
    ...
    <v-list density="compact" nav>
      ...
      <v-list-item :active="['Product', 'ProductCreate', 'ProductEdit'].includes($route.name)" prepend-icon="mdi-package-variant-closed"
        title="Produk" value="katalog" to="/admin/product"></v-list-item>
