<template>
    <v-app-bar color="primary" prominent>
        <v-toolbar-title>Katalog</v-toolbar-title>
    </v-app-bar>
                ...
                <v-sheet v-for="item in items" :key="item">
                    <v-card elevation="6" :loading="loading" class="mx-auto" width="275">
                        <template v-slot:loader="{ isActive }">
                            ...
                            <v-skeleton-loader v-if="isActive" style="margin-top: -13px;" type="heading"></v-skeleton-loader>
                        </template>
                        ...
                        <v-card-actions>
                            <v-btn color="light-blue-darken-4 font-weight-bold" :to="{ name: 'CatalogDetail', params: { id: item.id } }" text="Detail" block
                                variant="flat"></v-btn>
                        </v-card-actions>
                    </v-card>
                </v-sheet>
